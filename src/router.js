...
export const routes = [
  {
    ...
    meta: {
      ...
      description: 'This is a collection of official examples to showcase the features of VeeValidate'
    }
  },
  {
    path: '/basic',
  ...
  },
  {
    ...
    meta: {
      ...
      description: 'A simple backend validation example with unique email validator'
    }
  },
  {
    path: '/models',
  ...
  },
  {
    ...
    meta: {
      ...
      description: 'Using validator instance without the directive to validate inputs.'
    }
  },
  {
    path: '/vuex',
